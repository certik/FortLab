pure subroutine interchange_sort_list_and_map_int(vec,map)
...
pure subroutine interchange_sort_list_and_map_real(vec,map)
...
pure subroutine interchange_sort_list_and_map_dble(vec,map)
