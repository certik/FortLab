program main
  ...
  implicit none
  interface
     subroutine c_qsort_int (n,x,t) bind(c)
       use iso_c_binding
  ...
  print '("------------------------------------------------------------")'
  print '("Time (sec)         C qsort  Fort Arrange")' 
  ...
  y_int = x_int
  call c_qsort_int(n,y_int,t)
  call cpu_time(t0)
  call sort(x_int)
  call cpu_time(t1)
  print '("Integer         ",I10,"    ",F10.2)',t,t1 - t0 
  ...
  call sort(x_real)
  call cpu_time(t1)
  print '("Fort Arrange ",F10.2," seconds")',t1 - t0
